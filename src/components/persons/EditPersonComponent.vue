<template>
  <div class="modal fade border-primary" tabindex="-1" aria-labelledby="exampleModalLabel" id="editModal"
    aria-hidden="true">
    <!-- Componente para editar persona -->
...
// Definir las propiedades que recibirá el componente para editar la persona correspondiente
