    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
          ...
          <button type="button" class="btn btn-danger btn-custom2" @click="deleteContact" data-bs-dismiss="modal">
...
// Inicializar store de Contactos
const contactStore = useContactsStore()
// Definir propiedades que recibirá el componente para eliminar el contacto correspondiente
const props = defineProps({
  con_id: Number
})
// Mandar los datos a la función deleteContact para eliminar el contacto
